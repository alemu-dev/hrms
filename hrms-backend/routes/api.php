...
Route::get('/leave-requests/{employeeId}', [LeaveRequestController::class, 'indexByEmployee']); // employee views own
...
// Fetch employee profile by user_id (for EmployeeWorkspace)
